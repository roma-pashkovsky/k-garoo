...
<div
	class="!p-0 !inline-block flex items-center input-wrapper {isCustomCategoryOpen
		? 'custom-open'
		: ''} {fullWidth ? 'w-full' : ''}"
>
	{#if isCustomCategoryOpen}
		<Iconinput
			...
			noBorderInputClass="inline-block !border-none w-full disabled:cursor-not-allowed disabled:opacity-50 bg-gray-50 border-gray-300 text-gray-900 focus:border-blue-500 focus:outline-none focus:bg-blue-100 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500 dark:bg-gray-600 dark:border-gray-500 p-2.5 text-sm"
