...
export default {
	en: {
		...
		'lists.details.link-to-list': 'Link',
	...
	ua: {
		...
		'app.login-popup.failed-to-login-error':
			'Не вдалося увійти в систему ({{code}}). Будь ласка, перезавантажте сторінку і спробуйте знову.',
		...
		'lists.details.link-to-list': 'Поділитися',
